...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    useEffect(() => {
      const fetchDocumentCount = async () => {
        try {
          const response = await axios.get('https://westminster-real-estate-backend.onrender.com/api/user/total-users');
          console.log(response.data);
    ...
    useEffect(() => {
      const fetchDocumentCount = async () => {
        try {
          const response = await axios.get('https://westminster-real-estate-backend.onrender.com/api/property/count-pending-properties');
          console.log(response.data);
